...
export const metadata: Metadata = {
  title: 'Where to Buy Johnnie Walker in Ludhiana | Find My Bottle Club',
  description: 'Looking to buy Johnnie Walker in Ludhiana? Find My Bottle Club checks availability across verified Ludhiana stores and WhatsApps you when confirmed in stock.',
  keywords: 'johnnie walker ludhiana, black label ludhiana, scotch whisky ludhiana',
}
      ...
      <main>
        <div className="seo-page container">
          <div className="seo-hero">
            ...
            <h1 className="seo-h1">Where to Buy Johnnie Walker in Ludhiana</h1>
            <p className="seo-intro">
              The world's best-selling Scotch. Black Label, Red Label, Gold Label. Finding it in Ludhiana can be hit or miss.
          ...
          <div className="seo-card">
            <h3>Is Johnnie Walker available in Ludhiana?</h3>
          ...
          <div className="seo-card">
            ...
            <p>If our network cannot confirm Johnnie Walker right now, you go on the watchlist for it. For the next 60 days, the moment any verified store in your area confirms it is in stock, you receive one WhatsApp. No reminders, no follow-ups, and nothing at all if it is never confirmed.</p>
          </div>
          <div className="seo-cta">
            <h2>Search for Johnnie Walker now</h2>
