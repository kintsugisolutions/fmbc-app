...
export const metadata: Metadata = {
  title: "Where to Buy Hendrick's Gin in Ludhiana | Find My Bottle Club",
  description: "Looking to buy Hendrick's Gin in Ludhiana? Find My Bottle Club checks availability across verified Ludhiana stores and WhatsApps you when confirmed in stock.",
  keywords: 'hendricks gin ludhiana, buy gin ludhiana, imported gin ludhiana',
}
      ...
      <main>
        <div className="seo-page container">
          <div className="seo-hero">
            ...
            <h1 className="seo-h1">Where to Buy Hendrick's Gin in Ludhiana</h1>
            <p className="seo-intro">
              Scotland's most distinctive gin. Cucumber and rose petal. Imported. Finding it in Ludhiana can be hit or miss.
          ...
          <div className="seo-card">
            <h3>Is Hendrick's Gin available in Ludhiana?</h3>
